            ...
            <div className="card-body ">
                ...
                <div className="mt-2 flex justify-center items-center flex-wrap">
                    ...
                    <button
                        ...
                        className="hover:bg-blue-500 hover:border-blue-600 hover:text-white rounded-full p-3"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">
